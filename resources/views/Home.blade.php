 ...
 <div class="row">
     <div class="col-md-8">
         <div class="scroll-stylish">
             <div class="post">
                 <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createPostModal"
                     id="openModalButton">
                     ...
                     <div class="d-flex flex-start w-100">
                         ...
                         <div data-mdb-input-init class="form-outline w-100">
                             <form method="post" action="{{ route('commentsave') }}">
                                 @csrf
                                 <textarea class="form-control" id="textAreaExample" rows="2" style="background: #fff;"
                                     placeholder="Leave a Solution" name="comment"></textarea>
                                 <input type="submit" value="post comment" class="btn btn-success">
                             </form>
                         </div>
                     </div>
                     <div class="float-end mt-2 pt-1">
                         <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-success btn-sm"
                             data-toggle="modal" data-target="#ViewComment"><i class="fa fa-eye"></i></button>
                         <!-- View Comment Modal -->
                         <div class="modal fade" id="ViewComment" tabindex="-1" aria-labelledby="createPostModalLabel"
                             aria-hidden="true">
                             <div class="modal-dialog">
                                 <div class="modal-content">
                                     <div class="modal-header">
                                         <h5 class="modal-title" id="createPostModalLabel">View Solutions</h5>
                                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                             <span aria-hidden="true">&times;</span>
                                         </button>
                                     </div>
                                     <div class="modal-body">
                                         @foreach ($comments as $comment)
                                             <p style="color:black !important;">{{ $comment->comment }}</p>
                                         @endforeach
                                     </div>
                                     <div class="modal-footer">
                         ...
                         <button type="button" data-mdb-button-init data-mdb-ripple-init
                             class="btn btn-danger btn-sm" data-toggle="modal" data-target="#Report">Report</button>
                         <!-- Report Modal -->
                     ...
                     <div class="d-flex flex-start w-100">
                         ...
                         <div data-mdb-input-init class="form-outline w-100">
                             <textarea class="form-control" id="textAreaExample" rows="4" style="background: #fff;"
                                 placeholder="Leave a Solution"></textarea>
                         </div>
                     </div>
                     <div class="float-end mt-2 pt-1">
                         <button type="button" data-mdb-button-init data-mdb-ripple-init
                             class="btn btn-success btn-sm">Post comment</button>
                         <button type="button" data-mdb-button-init data-mdb-ripple-init
