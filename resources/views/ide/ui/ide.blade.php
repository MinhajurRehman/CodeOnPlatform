...
<div class="container">
        ...
        <div class="header timer">
              <p>
                 <i> End Time: </i> <span id="countdown"></span>
              </p>
            </div>
        ...
        <div class="control-panel">
            <select id="languages" class="languages" onchange="changelanguage()">
                ...
                <option value="{{ $tournaments->t_Plang }}">
                    {{ $tournaments->t_Plang }}
                </option>
            </select>
        </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="border p-3 text-center points">
                        ...
                        <form method="post">
                            ...
                            <div class="d-flex justify-content-center align-items-center" style="height: 100px;">
                                {{--  <span class="display-4" name="points" id="pointsResult">50</span>  --}}
...
let countdownTime = {{ $tournaments->t_board_time * 60 }};
